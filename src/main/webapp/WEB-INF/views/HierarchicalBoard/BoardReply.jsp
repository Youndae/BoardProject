		...
		<form method="post" id="ReplyFrm">
			<div>
				<label for="BoardTitle">제목</label> <input type="text"
					...
					value="RE: ${boardReply.boardTitle}" readonly="readonly">
			</div>
			<div>
				<label for="BoardContent">내용</label>
				<textarea id="BoardContent" name="BoardContent"
					placeholder="내용을 입력하세요" style="width: 300px; height: 300px;"></textarea>
			</div>
			...
			<input type="hidden" name="BoardGroupNo"
				value="${boardReply.boardGroupNo}"> <input type="hidden"
				name="BoardIndent" value="${boardReply.boardIndent}">
		</form>
	</div>
</body>
