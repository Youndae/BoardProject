		...
		<div class="layer">
			...
			<form action="LoginProc" id="LoginForm" method="post">
				<div class="mb-2">
					...
					<input style="margin-left:40px;" type="text" id="UserId" name="UserId" class="form-control" placeholder="아이디" required autofocus>
					<span style="margin-left:40px; color: red; font-size: 10pt;" id="NullId" ></span>
				</div>
				<div class="mb-2">
					<label style="margin-left:40px;">비밀번호</label>
					<input style="margin-left:40px;" type="password" id="UserPw" name="UserPw" class="form-control" placeholder="비밀번호" required>
